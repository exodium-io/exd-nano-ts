...
export class FileLoader {
    ...
    public async setUp(opts): Promise<Record<string, string>> {
        ...
        this.CONFIG_PATH = `../.config/dpos-nano/${opts.chain}/${opts.network}`;
...
/*
            const path = `${resolve(this.CONFIG_PATH)}/peers.json`;
